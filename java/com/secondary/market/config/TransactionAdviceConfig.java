package com.secondary.market.config;
...
public class TransactionAdviceConfig {
     ...
     * 3.com.secondary.market.service表示切入点的包名
     * 4.第二个*号:表示实现包
     * 5.*(..)*号表示所有方法名,..表示所有类型的参数
     */
    private static final String POITCUT_EXPRESSION = "execution(* com.secondary.market.service.*.*(..))";
    @Autowired
